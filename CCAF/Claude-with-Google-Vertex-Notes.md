...
> [_Claude with Google Vertex_](https://anthropic-partners.skilljar.com/claude-with-google-vertex).
> 83 lessons across 12 sections. Written notes exist for 67 lessons; hands-on exercises,
> video-only demos, and the Vertex AI Setup text lesson have no note text in the page bundle.
...
_(text lesson - no written notes)_
...
### 34. Multi-turn conversations with tools
...
### 35. Implementing multiple turns
...
### 41. Introducing Retrieval Augmented Generation
